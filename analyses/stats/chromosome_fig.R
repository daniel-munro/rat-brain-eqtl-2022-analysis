...
ggsave("analyses/stats/chrom_jitter.png")
...
genes |>
    ...
    geom_segment(linewidth = 0.1, alpha = 0.75) +
    theme_minimal()

ggsave("analyses/stats/chrom_lines.png")
...
ggsave("analyses/stats/chromosome_fig.png", width = 12, height = 10)
...
(q1 + q2) / (q3 + q4)
ggsave("analyses/stats/chrom_scatter.png")
