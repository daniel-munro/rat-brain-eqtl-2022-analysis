...
# p3_vals <- scales::rescale(c(min(top$pve), (0:4) * max(top$pve) / 4))
...
# # ggsave("eGene_overlap2.png", width = 8, height = 3.5)
...
top |>
    ...
    geom_linerange(color = "gray", size = 0.1) +
    geom_point(size = 0.2) +
